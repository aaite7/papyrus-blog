...
export function injectGlobalStyles() {
  ...
  style.innerHTML = `
    ...
    * { box-sizing: border-box; }
    ...
    /* >>> 这里的 flex-direction: column 是让它们垂直居中的关键 <<< */
    .manuscript-header {
        display: flex;
    ...
    /* 日期 */
    .manuscript-date { font-size: 0.9rem; color: #999; font-family: 'Lora', serif; }
    ...
    #toc a { display: block; margin-bottom: 12px; color: #999; text-decoration: none; font-size: 0.9rem; font-family: 'Lora', serif; transition: 0.2s; padding-left: 10px; border-left: 3px solid transparent; margin-left: -12px; }
    #toc a:hover { color: #D4AF37; padding-left: 15px; }
    #toc a.active { color: #8B0000; font-weight: bold; padding-left: 15px; border-left-color: #8B0000; }
    @media (max-width: 1200px) { #toc { display: none !important; } }

    /* --- 其他组件 (保持一致) --- */
    .single-manuscript { max-width: 800px !important; margin: 40px auto; padding: 0 20px; position: relative; }
    ...
    .editor-textarea:focus { border-color: #D4AF37 !important; }
