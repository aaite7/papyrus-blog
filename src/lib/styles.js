...
export function injectGlobalStyles() {
  ...
  style.innerHTML = `
    ...
    /* --- 2. UI 组件 (进度条、Toast、悬浮岛) --- */
    #reading-progress { position: fixed; top: 0; left: 0; width: 0%; height: 6px; background: linear-gradient(90deg, #FFD700, #FF4500); z-index: 9999999; transition: width 0.1s linear; box-shadow: 0 2px 8px rgba(0,0,0,0.5); pointer-events: none; display: block !important; }
    ...
    .floating-bar { position: fixed; bottom: 50px; right: 30px; display: flex; flex-direction: column; gap: 15px; z-index: 99999; }
